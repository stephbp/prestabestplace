...
class PosListCateProduct extends Module implements WidgetInterface
{
	...
	protected function installDemoData()
	{
		...
		for ($i = 1; $i <= 2; ++$i)
		{
			...
			{
				if($i==1){
					$item->description[$language['id_lang']]='<div class="super_st">
					<div class="banner-box"><a href="#"> <img src="/pos_optima_electronic/img/cms/img4.jpg" alt="banner" class="img-responsive" /> </a></div>
					</div>';
				}elseif($i==2){
					$item->description[$language['id_lang']]='<div class="super_st">
					<div class="banner-box"><a href="#"> <img src="/pos_optima_electronic/img/cms/img5.jpg" alt="banner" class="img-responsive" /> </a></div>
					</div>';
				}elseif($i==3){
    ...
    public function getWidgetVariables($hookName = null, array $configuration = [])
    {
	   ...
	   $item['description'] = str_replace('/pos_optima_electronic/',__PS_BASE_URI__,$item['description']);
	  }
        if (is_array($items))
			foreach ($items as &$item)
			{	
	...
	{	
		...
		foreach ($languages as $lang)
		{
			...
			$fields['description'][$lang['id_lang']] = str_replace('/pos_optima_electronic/',__PS_BASE_URI__,$fields['description'][$lang['id_lang']]);
		}
