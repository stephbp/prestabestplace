...
<div class="panel"><h3><i class="icon-list-ul"></i> {l s='Menu Item' mod='posvegamenu'}</h3>
	<div class="form-wrapper" id="menuContent" >
		...
		<div class="form-group lab-fw-icon">
			...
			<div class="col-lg-9">
				...
				<p>{l s='Put class icon of Font-Awesome at :' mod='posvegamenu'} <a href="http://fortawesome.github.io/Font-Awesome/3.2.1/icons/">http://fortawesome.github.io/Font-Awesome/3.2.1/icons/.</a>ex: <span class="o-40">&lt;i class="</span>fab fa-angellist<span class="o-40">"&gt;&lt;/i&gt;</span></p>   
			</div>
		</div>
	...
	<div class="form-group">
		<label class="control-label col-lg-1" for="">{l s='Main link style' mod='posvegamenu'}</label>
		<div class="col-lg-11">
			<div class="row">
				
				<div class="form-group col-lg-3" style="width: 23%;">
	                <label class="control-label col-lg-4" for="color">{l s='Color' mod='posvegamenu'}</label>
	                <div class="col-lg-8">
	            ...
	            <div class="form-group col-lg-3" style="width: 23%;">
	                <label class="control-label col-lg-4" for="color_hover">{l s='Color hover' mod='posvegamenu'}</label>
	                <div class="col-lg-8">
	                    <div class="input-group">
	            ...
	            <div class="form-group col-lg-2">
	                <label class="control-label col-lg-6" for="fontsize">{l s='Font size' mod='posvegamenu'}</label>
	                <div class="col-lg-6">
	                    <div class="input-group">
	            ...
	            <div class="form-group col-lg-2">
	                <label class="control-label col-lg-6" for="lineheight">{l s='Line height' mod='posvegamenu'}</label>
	                <div class="col-lg-6">
	                    <div class="input-group">
	            ...
	            <div class="form-group col-lg-2" style="width: 20%;">
			        <label class="control-label col-lg-6" for="transform">{l s='Text transform' mod='posvegamenu'}</label>
			        <div class="col-lg-6">
			            <select id="transform" name="transform" class="form-control" data-default="0">
			                <option value="0" {if $menu->item_transform == 0}selected="selected" {/if}>{l s='none' mod='posvegamenu'}</option>
			                <option value="1" {if $menu->item_transform == 1}selected="selected" {/if}>{l s='UPPERCASE' mod='posvegamenu'}</option>
			                <option value="2" {if $menu->item_transform == 2}selected="selected" {/if}>{l s='Capitalize' mod='posvegamenu'}</option>
			            </select>
			        </div>
			    </div>
	            <div style="clear:both;"></div>
	            <div class="form-group col-lg-3" style="width: 23%;">
	                <label class="control-label col-lg-4" for="bgcolor">{l s='Background color' mod='posvegamenu'}</label>
	                <div class="col-lg-8">
	                    <div class="input-group">
	            ...
	            <div class="form-group col-lg-3" style="width: 23%;">
	                <label class="control-label col-lg-4" for="bgcolor_hover">{l s='Background hover' mod='posvegamenu'}</label>
	                <div class="col-lg-8">
	                    <div class="input-group">
