...
class Posslideshows extends Module implements WidgetInterface
{
        ...
        for ($i = 1; $i <= 2; ++$i) {
            ...
            foreach ($languages as $language) {
				...
				if($i==1){
					...
					<div class="container">
					<p class="title5">Double Bass</p>
					<p class="title1">b200 bluetooth</p>
					<p class="title2">Wired And Wireless</p>
					<p class="title3">Long Battery Life Of 15-20 Hours</p>
					<p class="readmore"><a href="#">Shop Now</a></p>
					</div>
					</div>';
				}elseif($i==2){
					$slide->description[$language['id_lang']] = '<div class="info desc1">
					<div class="container">
					<p class="title5">G02E Best New Virtual Reality</p>
					<p class="title1">Samsung gear Vr</p>
					<p class="title2">Virtual Reality Glasses</p>
					<p class="title3">Largest 42MM HD Optical Resin Lenses</p>
					<p class="readmore"><a href="#">Shop Now</a></p>
					</div>
					</div>';
				}
    ...
    public function getWidgetVariables($hookName = null, array $configuration = [])
    {
		...
		foreach($slides as &$slide){
			...
			$slide['description'] = str_replace('/pos_optima5/',__PS_BASE_URI__,$slide['description']);
		}
        if (is_array($slides)) {
            foreach ($slides as &$slide) {
    ...
    public function getAddFieldsValues()
    {
        ...
        $languages = Language::getLanguages(false);
		 ...
		 foreach ($languages as $lang) {
			...
			$fields['description'][$lang['id_lang']] = str_replace('/pos_optima5/',__PS_BASE_URI__,$fields['description'][$lang['id_lang']]);
		}
