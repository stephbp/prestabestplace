...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.43',
  'unifunc' => 'content_62b9a7b56de3d1_23640199',
...
function content_62b9a7b56de3d1_23640199 (Smarty_Internal_Template $_smarty_tpl) {
?>
			...
			<div class="pos_search form-group">
				 <?php if ($_smarty_tpl->tpl_vars['cate_on']->value == 1) {?>
					<select class="bootstrap-select" name="poscats">
						<option value="0"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Catégories','mod'=>'blocksearch_mod'),$_smarty_tpl ) );?>
</option>
							<?php
...
" placeholder="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Que recherchez vous... ','mod'=>'possearchcategories'),$_smarty_tpl ) );?>
