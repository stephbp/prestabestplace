...
class FrontContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $d = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/var/www/vhosts/lagrandebraderie.mg/presta.lagrandebraderie.mg/modules/productcomments/src/Entity']);
        $d->addExcludePaths([0 => '/var/www/vhosts/lagrandebraderie.mg/presta.lagrandebraderie.mg/modules/productcomments/src/Entity/index.php']);
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/var/www/vhosts/lagrandebraderie.mg/presta.lagrandebraderie.mg/modules/ps_checkout/src/Entity']);
        $e->addExcludePaths([0 => '/var/www/vhosts/lagrandebraderie.mg/presta.lagrandebraderie.mg/modules/ps_checkout/src/Entity/index.php']);

        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/var/www/vhosts/lagrandebraderie.mg/presta.lagrandebraderie.mg/src/PrestaShopBundle/Entity']), 'PrestaShop');
        ...
        $a->setProxyDir('/var/www/vhosts/lagrandebraderie.mg/presta.lagrandebraderie.mg/var/cache/prod//doctrine/orm/Proxies');
    ...
    {
        return $this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/var/www/vhosts/lagrandebraderie.mg/presta.lagrandebraderie.mg/var/cache/prod//localization');
    }
    ...
    {
        $this->services['prestashop.core.localization.cldr.datalayer.locale_cache'] = $instance = new \PrestaShop\PrestaShop\Core\Localization\CLDR\DataLayer\LocaleCache(${($_ = isset($this->services['prestashop.core.localization.cldr.cache.adapter']) ? $this->services['prestashop.core.localization.cldr.cache.adapter'] : ($this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/var/www/vhosts/lagrandebraderie.mg/presta.lagrandebraderie.mg/var/cache/prod//localization'))) && false ?: '_'});
    ...
    {
        return $this->services['ps_checkout.cache.directory'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('1.7.8.6', '/var/www/vhosts/lagrandebraderie.mg/presta.lagrandebraderie.mg', false);
    }
    ...
    {
        return $this->services['ps_checkout.cache.paypal.merchant_integration'] = new \Symfony\Component\Cache\Simple\FilesystemCache('merchant-integration', 86400, ${($_ = isset($this->services['ps_checkout.cache.directory']) ? $this->services['ps_checkout.cache.directory'] : ($this->services['ps_checkout.cache.directory'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('1.7.8.6', '/var/www/vhosts/lagrandebraderie.mg/presta.lagrandebraderie.mg', false))) && false ?: '_'}->getPath());
    }
    ...
    {
        return $this->services['ps_checkout.logger.directory'] = new \PrestaShop\Module\PrestashopCheckout\Logger\LoggerDirectory('1.7.8.6', '/var/www/vhosts/lagrandebraderie.mg/presta.lagrandebraderie.mg');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.root_dir' => '/var/www/vhosts/lagrandebraderie.mg/presta.lagrandebraderie.mg/app',
            'kernel.project_dir' => '/var/www/vhosts/lagrandebraderie.mg/presta.lagrandebraderie.mg',
            'kernel.name' => 'app',
            'kernel.debug' => false,
            'kernel.environment' => 'prod',
            'kernel.cache_dir' => '/var/www/vhosts/lagrandebraderie.mg/presta.lagrandebraderie.mg/var/cache/prod/',
            ...
            'ps_cache_dir' => '/var/www/vhosts/lagrandebraderie.mg/presta.lagrandebraderie.mg/var/cache/prod/',
            ...
            'doctrine.orm.proxy_dir' => '/var/www/vhosts/lagrandebraderie.mg/presta.lagrandebraderie.mg/var/cache/prod//doctrine/orm/Proxies',
