...
<div class="poslistcategories">
		...
		<div class="pos_title">
			<h2>{l s='Popular Categories' d='Shop.Theme.Customeraccount'}</h2>
			<span class="text">{l s='Add featured categories to weekly line up' d='Shop.Theme.Customeraccount'}</span>
		</div>
					...
					{/if}	
						<div class="list-categories">
							...
							<div class="desc-listcategoreis">
								...
								<p class="number_product">{$category.nbProducts} {l s='products' d='Shop.Theme.Customeraccount'}</p>		
								<div class="shop_now" ><a href="{$link->getCategoryLink($category['id_category'])}" target="_blank">{l s='Shop Now' d='Shop.Theme.Customeraccount'}</a></div>
