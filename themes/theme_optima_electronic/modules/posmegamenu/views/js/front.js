...
{	
	...
	$(window).scroll(function() {
		...
		if ($(this).scrollTop() > headerSpaceH && screenWidth >= 992 ){  
			  $(".bottom_header").parents("#header").find(".bottom_header").addClass("scroll-menu");
			  $(".bottom_header").parents("#header").find(".bottom_header").addClass(" animated fadeInDown");
		}
		else{
			 $(".bottom_header").parents("#header").find(".bottom_header").removeClass("scroll-menu");
			$(".bottom_header").parents("#header").find(".bottom_header").removeClass("animated fadeInDown"); 		
		}
	});
