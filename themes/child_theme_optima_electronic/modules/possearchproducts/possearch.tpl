...
<div id="_desktop_search_category" class="pos_search_top">
	<div id="pos_search_top">
		<form method="get" action="{$search_controller_url}" id="searchbox" class="form-inline form_search"  data-search-controller-url="{$url_search|escape:'html'}">
			...
			<div class="pos_search form-group">
				 {if $cate_on == 1}
					<select class="bootstrap-select" name="poscats">
						<option value="0">{l s='Catégories' mod='blocksearch_mod'}</option>
			...
			<input type="text" name="s" value="{$search_string}" placeholder="{l s='Que recherchez vous... ' mod='possearchcategories'}" id="pos_query_top" class="search_query form-control ac_input" >
